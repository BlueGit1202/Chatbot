...
- If the total price is more than £200, then the real total price = [£200 + (total price - 200) * 0.75+£10],and then rounded up to the nearest £5(it means real total price= [floor(realtotalprice/10)]*10+result(realtotalprice%10<5 then result=0 else realtotalprice%10>5 then result=5 )). Do not send this real total price formula to customers—say it's not allowed by Richard.
